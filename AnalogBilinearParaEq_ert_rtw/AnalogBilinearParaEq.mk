###########################################################################
## Makefile generated for Simulink model 'AnalogBilinearParaEq'. 
## 
## Makefile     : AnalogBilinearParaEq.mk
## Generated on : Fri Jan 03 15:45:49 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/AnalogBilinearParaEq.elf
...
PRODUCT_NAME              = AnalogBilinearParaEq
MAKEFILE                  = AnalogBilinearParaEq.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/OneDrive - sci.kmutnb.ac.th/Documents/MATLAB/STM32F769_DSP_Matlab_Simulink
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = AnalogBilinearParaEq_comp.rsp
CMD_FILE                  = AnalogBilinearParaEq.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/AnalogBilinearParaEq.elf
...
DEFINES_STANDARD = -DMODEL=AnalogBilinearParaEq -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = stm32f7_audio_wrapper.o stm32f769i_discovery.o stm32f769i_discovery_audio.o wm8994.o AnalogBilinearParaEq.o AnalogBilinearParaEq_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o stm32f769i_init_board.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/AnalogBilinearParaEq_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/AnalogBilinearParaEq_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/AnalogBilinearParaEq_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/AnalogBilinearParaEq_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/AnalogBilinearParaEq_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
