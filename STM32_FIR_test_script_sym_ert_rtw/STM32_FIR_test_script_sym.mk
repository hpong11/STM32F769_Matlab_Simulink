###########################################################################
## Makefile generated for Simulink model 'STM32_FIR_test_script_sym'. 
## 
## Makefile     : STM32_FIR_test_script_sym.mk
## Generated on : Sun Aug 26 22:27:39 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/STM32_FIR_test_script_sym.elf
...
PRODUCT_NAME              = STM32_FIR_test_script_sym
MAKEFILE                  = STM32_FIR_test_script_sym.mk
COMPUTER                  = PCWIN64
...
MODELREF_LINK_RSPFILE_NAME = STM32_FIR_test_script_sym_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/STM32_FIR_test_script_sym.elf
...
OBJS = stm32f7_audio_wrapper.o stm32f769i_discovery.o stm32f769i_discovery_audio.o wm8994.o STM32_FIR_test_script_sym.o STM32_FIR_test_script_sym_data.o stm32f769i_init_board.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/STM32_FIR_test_script_sym_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/STM32_FIR_test_script_sym_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/STM32_FIR_test_script_sym_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/STM32_FIR_test_script_sym_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/STM32_FIR_test_script_sym_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
