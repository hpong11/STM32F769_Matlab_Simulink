###########################################################################
## Makefile generated for Simulink model 'Test_switch'. 
## 
## Makefile     : Test_switch.mk
## Generated on : Wed Apr 24 17:26:09 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Test_switch.elf
...
COMPILER_COMMAND_FILE     = Test_switch_comp.rsp
CMD_FILE                  = Test_switch.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Test_switch.elf
...
DEFINES_STANDARD = -DMODEL=Test_switch -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o xcp_ext_work.o Test_switch.o Test_switch_data.o xcp_ext_common.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o stm32f769i_init_board.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o rtiostream_serial_mbed.o sys_arch.o
...
%.o : $(START_DIR)/Test_switch_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/Test_switch_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Test_switch_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/Test_switch_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Test_switch_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
