###########################################################################
## Makefile generated for Simulink model 'TestPortF769'. 
## 
## Makefile     : TestPortF769.mk
## Generated on : Fri Nov 29 17:45:22 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/TestPortF769.elf
...
COMPILER_COMMAND_FILE     = TestPortF769_comp.rsp
CMD_FILE                  = TestPortF769.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/TestPortF769.elf
...
DEFINES_STANDARD = -DMODEL=TestPortF769 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o stm32f7_audio_wrapper.o stm32f769i_discovery.o stm32f769i_discovery_audio.o wm8994.o TestPortF769.o TestPortF769_data.o stm32f769i_init_board.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/TestPortF769_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/TestPortF769_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/TestPortF769_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/TestPortF769_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/TestPortF769_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
