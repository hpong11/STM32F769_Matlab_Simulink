...
#ifndef RTW_HEADER_DirectII_h_
#define RTW_HEADER_DirectII_h_
#include <math.h>
#include <string.h>
#include <float.h>
#include <stddef.h>
#ifndef DirectII_COMMON_INCLUDES_
# define DirectII_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "wm8994.h"
#endif                                 /* DirectII_COMMON_INCLUDES_ */

#include "DirectII_types.h"
...
struct P_DirectII_T_ {
  real_T Gain_Gain;                    /* Expression: 1/32768
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T AlphaLP_Value;                /* Expression: 0.8
                                        * Referenced by: '<S2>/Alpha LP'
                                        */
  real_T BetaLP_Value;                 /* Expression: 0.8090000000000001
                                        * Referenced by: '<S2>/Beta LP'
                                        */
  real_T AlphaHP_Value;                /* Expression: 0.6242236024844721
                                        * Referenced by: '<S2>/Alpha HP'
                                        */
  real_T BetaHP_Value;                 /* Expression: 0.4
                                        * Referenced by: '<S2>/Beta HP'
                                        */
  real_T AlphaBP_Value;                /* Expression: 0.5574534161490683
                                        * Referenced by: '<S2>/Alpha BP'
                                        */
  real_T BetaBP_Value;                 /* Expression: -0.07598784194528874
                                        * Referenced by: '<S2>/Beta BP'
                                        */
  real_T AlphaBS_Value;                /* Expression: 0.6242236024844721
                                        * Referenced by: '<S2>/Alpha BS'
                                        */
  real_T BetaBS_Value;                 /* Expression: -0.8090000000000001
...
extern P_DirectII_T DirectII_P;

/* Block signals (default storage) */
extern B_DirectII_T DirectII_B;

/* Block states (default storage) */
extern DW_DirectII_T DirectII_DW;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_DirectII_T DirectII_Y;

/* Model entry point functions */
extern void DirectII_initialize(void);
extern void DirectII_step(void);
extern void DirectII_terminate(void);

/* Real-time Model object */
extern RT_MODEL_DirectII_T *const DirectII_M;
 ...
 *
 * '<Root>' : 'DirectII'
 * '<S1>'   : 'DirectII/MATLAB Function'
 * '<S2>'   : 'DirectII/Subsystem'
 * '<S3>'   : 'DirectII/Subsystem/Tune Parameter'
 */
#endif                                 /* RTW_HEADER_DirectII_h_ */
