###########################################################################
## Makefile generated for Simulink model 'DirectII'. 
## 
## Makefile     : DirectII.mk
## Generated on : Mon Nov 25 12:22:14 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DirectII.elf
...
COMPILER_COMMAND_FILE     = DirectII_comp.rsp
CMD_FILE                  = DirectII.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DirectII.elf
...
DEFINES_STANDARD = -DMODEL=DirectII -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = stm32f7_audio_wrapper.o stm32f769i_discovery.o stm32f769i_discovery_audio.o wm8994.o xcp_ext_work.o DirectII.o DirectII_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o stm32f769i_init_board.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o rtiostream_serial_mbed.o sys_arch.o
...
%.o : $(START_DIR)/DirectII_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/DirectII_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/DirectII_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/DirectII_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/DirectII_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
