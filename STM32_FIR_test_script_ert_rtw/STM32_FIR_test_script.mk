###########################################################################
## Makefile generated for Simulink model 'STM32_FIR_test_script'. 
## 
## Makefile     : STM32_FIR_test_script.mk
## Generated on : Fri Dec 20 12:39:20 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/STM32_FIR_test_script.elf
...
PRODUCT_NAME              = STM32_FIR_test_script
MAKEFILE                  = STM32_FIR_test_script.mk
COMPUTER                  = PCWIN64
...
COMPILER_COMMAND_FILE     = STM32_FIR_test_script_comp.rsp
CMD_FILE                  = STM32_FIR_test_script.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/STM32_FIR_test_script.elf
...
DEFINES_STANDARD = -DMODEL=STM32_FIR_test_script -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = stm32f7_audio_wrapper.o stm32f769i_discovery.o stm32f769i_discovery_audio.o wm8994.o STM32_FIR_test_script.o STM32_FIR_test_script_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o stm32f769i_init_board.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/STM32_FIR_test_script_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/STM32_FIR_test_script_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/STM32_FIR_test_script_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/STM32_FIR_test_script_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/STM32_FIR_test_script_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
