###########################################################################
## Makefile generated for Simulink model 'Sine_test'. 
## 
## Makefile     : Sine_test.mk
## Generated on : Mon Sep 10 14:17:28 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Sine_test.elf
...
MODELREF_LINK_RSPFILE_NAME = Sine_test_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Sine_test.elf
...
DEFINES_STANDARD = -DMODEL=Sine_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/Sine_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/Sine_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Sine_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/Sine_test_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/Sine_test_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
