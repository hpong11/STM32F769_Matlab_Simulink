  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% untitled_DW.Chirp_CURRENT_STEP
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 200;
	
	  ;% untitled_DW.Chirp_ACC_PHASE
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 201;
	
	  ;% untitled_DW.Chirp_BETA
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 202;
	
	  ;% untitled_DW.Chirp_MIN_FREQ
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 203;
	
	  ;% untitled_DW.Chirp_PERIOD_THETA
	  section.data(6).logicalSrcIdx = 5;
	  ...
	  ;% untitled_DW.DiscreteFIRFilter_circBuf
	  ...
	  ;% untitled_DW.Chirp_SWEEP_DIRECTION
  ...
  targMap.checksum0 = 3610554373;
  targMap.checksum1 = 2734768126;
  targMap.checksum2 = 519767575;
  targMap.checksum3 = 3878515664;
