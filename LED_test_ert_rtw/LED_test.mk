###########################################################################
## Makefile generated for Simulink model 'LED_test'. 
## 
## Makefile     : LED_test.mk
## Generated on : Wed Apr 24 16:59:11 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LED_test.elf
...
COMPILER_COMMAND_FILE     = LED_test_comp.rsp
CMD_FILE                  = LED_test.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LED_test.elf
...
DEFINES_STANDARD = -DMODEL=LED_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o LED_test.o LED_test_data.o stm32f769i_init_board.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/LED_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/LED_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/LED_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/LED_test_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/LED_test_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
