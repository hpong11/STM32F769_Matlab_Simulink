###########################################################################
## Makefile generated for Simulink model 'STM32_IIR_test'. 
## 
## Makefile     : STM32_IIR_test.mk
## Generated on : Fri Dec 20 12:35:49 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/STM32_IIR_test.elf
...
COMPILER_COMMAND_FILE     = STM32_IIR_test_comp.rsp
CMD_FILE                  = STM32_IIR_test.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/STM32_IIR_test.elf
...
DEFINES_STANDARD = -DMODEL=STM32_IIR_test -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = stm32f7_audio_wrapper.o stm32f769i_discovery.o stm32f769i_discovery_audio.o wm8994.o STM32_IIR_test.o STM32_IIR_test_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o stm32f769i_init_board.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/STM32_IIR_test_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/STM32_IIR_test_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/STM32_IIR_test_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/STM32_IIR_test_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/STM32_IIR_test_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
