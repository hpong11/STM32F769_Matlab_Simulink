...
## Generated on : Wed Apr 24 14:54:23 2019
...
COMPILER_COMMAND_FILE     = untitled2_comp.rsp
CMD_FILE                  = untitled2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
OBJS = MW_digitalIO.o untitled2.o untitled2_data.o stm32f769i_init_board.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/untitled2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/untitled2_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/untitled2_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
